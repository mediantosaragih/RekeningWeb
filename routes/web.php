...
Route::group(['middleware' => 'userlogin'], function () {
    ...
    // });
    Route::middleware(['checkRoleUser:/rekening,menu'])->group(function () {
        // Rute CRUD standar
        Route::resource('admin/rekening', RekeningController::class);
    
        // Rute kustom (jika diperlukan)
        Route::get('/admin/rekening/create', [RekeningController::class, 'create'])->name('admin.rekening.create');
        Route::post('admin/rekening/proses_ubah/{rekening}', [RekeningController::class, 'proses_ubah'])->name('admin.rekening.update');
        Route::post('admin/rekening/proses_hapus/{rekening}', [RekeningController::class, 'proses_hapus'])->name('admin.rekening.delete');
    });

    Route::get('/admin/rekening', [RekeningController::class, 'index']);    
    ...
    Route::middleware(['checkRoleUser:/lap-stok-barang,submenu'])->group(function () {
        ...
        Route::middleware(['checkRoleUser:2,othermenu'])->group(function () {
            ...
            // Rute kustom (jika diperlukan)
            Route::get('/admin/rekening', [RekeningController::class, 'index'])->name('admin.rekening.index');
            Route::get('/admin/rekening/create', [RekeningController::class, 'create'])->name('admin.rekening.create');
        ...
        Route::middleware(['checkRoleUser:3,othermenu'])->group(function () {
            ...
            Route::put('/admin/rekening/{id}', [ApprovalController::class, 'update'])->name('admin.rekening.update');
            Route::post('/admin/rekening/update-status/{rekening}', [RekeningController::class, 'updateStatus'])->name('rekening.updateStatus');
            Route::put('admin/rekening/{id}', [ApprovalController::class, 'update'])->name('admin.rekening.update');
            Route::get('/admin/approval', [ApprovalController::class, 'index'])->name('admin.approval.index');
            Route::get('/admin/approval/create', [ApprovalController::class, 'create'])->name('admin.approval.create');
            Route::post('/admin/approval/store', [ApprovalController::class, 'store'])->name('admin.approval.store');
            Route::post('admin/approval/proses_ubah/{approval}', [ApprovalController::class, 'proses_ubah'])->name('admin.approval.update');
            Route::post('admin/approval/proses_hapus/{approval}', [ApprovalController::class, 'proses_hapus'])->name('admin.approval.delete');
        });
